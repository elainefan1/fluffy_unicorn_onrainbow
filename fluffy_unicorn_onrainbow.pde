...
void setup() {
  ...
  rainbow = loadImage("transparentrainbow.png");  // 2. Change this to match your file name. 
  ...
  unicorn = loadImage("fluffyunicorn.png"); // 5. Change this to match your file name.
}
